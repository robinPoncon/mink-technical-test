		...
		<div className="w-full px-4 pb-10">
			{animalSelected && openModal && (
				<div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50 z-10">
					<div className="bg-white p-5 rounded-lg shadow-lg w-72 sm:w-1/3 max-w-lg">
			...
			<div className="flex flex-col justify-center gap-4 pb-10 sm:flex-row">
				<h2 className="text-center text-lg my-auto font-semibold">
					Envie d'ajouter un nouvel animal ?
				</h2>
				<a
					className="flex py-2 px-3 gap-2 rounded-md bg-gray-700 text-white hover:bg-gray-900 w-fit mx-auto sm:mx-0"
					href="/animal/ajouter"
				>
					Ajouter
					<img
				...
				<table className="bg-white border-2 border-gray-300 rounded-md">
					<thead className="rounded-t-md">
						<tr>
							...
							<th className="border-2 py-2 px-3 border-gray-300 hidden sm:table-cell">
								Type
							</th>
							<th className="border-2 py-2 px-3 border-gray-300 hidden sm:table-cell">
								Race
					...
					<tbody className="rounded-b-md">
						{animals.map((animal) => (
							...
							>
								...
								<td className="p-4 border-2 border-gray-300 hidden sm:table-cell">
									{animal.type}
								</td>
								<td className="p-4 border-2 border-gray-300 hidden sm:table-cell">
									{animal.breed}
								...
								<td className="p-4 border-2 border-gray-300 flex gap-4 flex-col md:flex-row">
									<a
